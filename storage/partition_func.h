...
#define FILE_SYSTEM_TYPE	"ext4" 				//文件系统格式
#define MKFS				"/sbin/mkfs.ext4"	//Ext4 格式化程序
#define TUNE2FS 			"/sbin/tune2fs" 	//tune2fs 程序
#define RM 					"/bin/rm" 			//rm 程序
#define SB_COPY_OPTION		"sb=131072" 		//使用首个超级块副本挂载选项
#define SB_COPY_POSITION 	134217728 			//首个超级块副本位置 32768×4K

#define MMC_MOUNT_POINT 	"/media/hi_mmc" 	//SD卡挂载路径
#define HDD_MOUNT_POINT 	"/media/hi_sda" 	//硬盘挂载路径
#define HDD_MNT_DIFF_POS 	12 					//上面/media/hi_sda中a的位置

#define SUPER_BLOCK_SIZE 	(sizeof(struct ext4_super_block))
#define GRP_DESC_SIZE 		(sizeof(struct ext4_group_desc))
#define FS_BLOCK_SIZE 		4096		//本程序管理的文件系统块大小
#define PADDING_SIZE 		1024 		//块组0填充大小

#define PARTITION_NAME_LEN	64			//分区设备名称长度
#define MOUNT_POINT_LEN		24			//分区挂载路径长度
